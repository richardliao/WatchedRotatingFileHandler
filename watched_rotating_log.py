...
"""
WatchedRotatingFileHandler is a file handler which is safe for multiple 
processes rotating log file. 

It a combination of RotatingFileHandler and WatchedFileHandler, adapted from 
python"s logging handlers, enhanced with file lock to prevent processes contend 
